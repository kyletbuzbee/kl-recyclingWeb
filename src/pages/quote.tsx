    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto text-green-100">Get fair market pricing for your scrap metal with no obligation. Choose a service below to see what we need to provide you with an accurate quote.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 text-center">
          <button onClick={() => setFunnelOpen(true)} className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-xl transition-all duration-300 transform bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-700 hover:to-emerald-700 shadow-lg hover:shadow-xl hover:scale-105">
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-700 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <button onClick={() => setFunnelOpen(true)} className="px-8 py-4 bg-white text-green-700 font-bold rounded-lg hover:bg-gray-100 transition-colors text-lg">
